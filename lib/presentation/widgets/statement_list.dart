                            ...
                            return index >= state.result.length
                                ...
                                : GestureDetector(
                                    ...
                                    child: ListTile(
                                      ...
                                      tileColor: state.result[index].description
                                              .contains('PIX')
                                          ? kLightGrey
                                          : null,
                                      enableFeedback: true,
                                      ...
                                      subtitle: Column(
                                        ...
                                        children: [
                                          Text(
                                            state.result[index].to ??
                                                state.result[index].from
                                                    .toString(),
                                      ...
                                      trailing: Text(
                                        '${state.result[index].createdAt.day}/${state.result[index].createdAt.month}',
                                        style:
                                            const TextStyle(color: kDarkGrey),
                                        strutStyle:
                                            const StrutStyle(leading: 2),
                                      ),
                                    ),
                                  );
                          },
